...
"""
An attempt at trying to pause mid game. I could not get it to work.
def pause():
    paused = True
    while paused:
...
def main_menu():
    ...
    while run:
        ...
        pygame.display.update()
        for event in pygame.event.get():
            if event.type == pygame.QUIT:  #I could not get the game to close correctly, I tired https://stackoverflow.com/questions/19882415/closing-pygame-window and it didn't work 
                run = False
